...
from app.features.income.routers.sub_routers.Download.download_income import router as download_income_router

router = APIRouter()

router.include_router(get_income_router)
router.include_router(add_income_router)
router.include_router(download_income_router)
