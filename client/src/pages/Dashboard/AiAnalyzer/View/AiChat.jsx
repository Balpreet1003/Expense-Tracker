        ...
        return [
            {
                id: 1,
                role: "bot",
                text: "Hello! I'm your AI assistant. I can analyze your transactions and help you understand your spending patterns. What would you like to know?",
            },
        ];
    });
        ...
        if (!userId) {
            ...
            setMessages((prev) => [
                ...prev,
                {
                    id: Date.now() + 2,
                    role: "bot",
                    text: "Unable to identify the current user. Please log in again.",
                },
            ]);
        ...
        try {
            ...
            const response =
                await axiosInstance.post(
                    API_PATHS.AI_ASSISTANT.GET_RESPONSE,
                    {
                        user_id: userId,
                        prompt: text.trim(),
                    },
